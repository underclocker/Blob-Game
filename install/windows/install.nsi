...
;General
  ...
  InstallDir "$PROGRAMFILES\Blob Game"
...
;Interface Settings
  ...
  !define MUI_FINISHPAGE_RUN "$INSTDIR\Blob Game.exe"
...
Section "Blob Game" SecBlobGame
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$DESKTOP\Blob Game.lnk" "$INSTDIR\Blob Game.exe" "" "$INSTDIR\blob.ico"
    CreateShortCut "$SMPROGRAMS\$StartMenuFolder\Blob Game.lnk" "$INSTDIR\Blob Game.exe" "" "$INSTDIR\blob.ico"
