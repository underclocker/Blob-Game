package org.box2dLight;

import org.shaders.DiffuseShader;
import org.shaders.Gaussian;
import org.shaders.ShadowShader;
import org.shaders.WithoutShadowShader;
...
public class LightMap {
	...
	public LightMap(RayHandler rayHandler, int fboWidth, int fboHeight) {
		...
		constructLightMap( fboWidth, fboHeight);
	}

	public void constructLightMap(int fboWidth, int fboHeight) {
		if (fboWidth <= 0)
			fboWidth = 1;
		if (fboHeight <= 0)
			fboHeight = 1;
