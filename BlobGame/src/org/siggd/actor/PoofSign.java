 ...
 * 
 */
public class PoofSign extends Actor {
	private String mTex;
	 ...
	 *            The id
	 */
	public PoofSign(Level level, long id) {
		super(level, id);
		mName = "BlobSensor";
		mTex = "data/gfx/Tutorial_Poof001.png";
		...
		mAnimation.addFrame("data/gfx/Tutorial_Poof001.png");
		mAnimation.addFrame("data/gfx/Tutorial_Poof002.png");
		mAnimation.addFrame("data/gfx/Tutorial_Poof003.png");
	}
	...
	public void loadResources() {
		...
		man.load("data/gfx/Tutorial_Poof001.png", Texture.class);
		man.load("data/gfx/Tutorial_Poof002.png", Texture.class);
		man.load("data/gfx/Tutorial_Poof003.png", Texture.class);
	}
